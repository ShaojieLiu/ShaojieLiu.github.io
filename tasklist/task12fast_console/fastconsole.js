...
document.querySelector('body').insertAdjacentHTML('beforeend', `
  ...
  <div class=" console-window">
    ...
    <div class="window-btn-top btn-group btn-group-justified">
      <btn id="console" class="btn btn-lg btn-primary " data-tag=".window-console">Console</btn>
      <btn id="network" class="btn btn-lg btn-primary active" data-tag=".window-network">Network</btn>
      <btn id="storage" class="btn btn-lg btn-primary" data-tag=".window-storage">Storage</btn>
    </div>
    ...
    <div class="window-network">
      <div class="btn-group btn-group-justified window-network-top">
        <btn id="resource" class="btn btn-default active" data-tag="" data-action="resource">Resource</btn>
        <btn id="xhr" class="btn btn-default" data-tag="" data-action="xhr">XMLHttpRequest</btn>
      </div>
      <ol class="window-network-display">
      </ol>
      <div class="echartWin">
        <div id="echartRes"></div>
      </div>
    </div>
...
// <script src="js/echartRes.js"></script>
